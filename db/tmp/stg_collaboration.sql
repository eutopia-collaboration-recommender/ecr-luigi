{#WITH ref_stg_collaboration_orcid AS (SELECT *#}
{#                                     FROM {{ ref('stg_orcid_collaboration_orcid') }})#}
...
{#       o.orcid_article_id,#}
{#       o.orcid_author_id,#}
{#       o.orcid_publication_dt,#}
{#       o.orcid_affiliation_identifier,#}
...
{#       'orcid'                   AS source#}
{#FROM ref_stg_collaboration_orcid o#}
...
{#         LEFT JOIN src_orcid_member_work o#}
{#                   ON o.article_eid = e.article_eid#}
