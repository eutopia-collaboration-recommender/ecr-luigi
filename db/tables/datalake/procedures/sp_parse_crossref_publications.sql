...
BEGIN
    ...
    */
    ...
    WHERE udf_to_date_from_crossref_json(publication_metadata -> 'message' -> 'published') BETWEEN date_start AND date_end
...
CALL sp_parse_crossref_publications('2020-01-01', '2020-12-31');
