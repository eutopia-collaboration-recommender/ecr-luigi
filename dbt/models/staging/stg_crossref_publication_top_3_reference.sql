WITH ref_stg_crossref_publication_reference AS (SELECT article_doi,
                                                ...
                                                WHERE (
                                                          reference_article_title IS NOT NULL
                                                              OR reference_article_author IS NOT NULL
                                                              OR reference_article_unstructured IS NOT NULL
                                                              OR reference_article_journal_title IS NOT NULL
                                                          ))
SELECT article_doi,
